...
const AgentAuth: React.FC<AgentAuthProps> = ({
  propertyContext,
  onNavigate,
}) => {
  const {
  ...
  const approvedCount = myProperties.filter(
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setIsLoading(false);
      setSuccess(
        "Registration successful! Please login once an admin approves your account.",
      );
      setAuthView("LOGIN");
      setFullName("");
      setBusinessName("");
                  ...
                  {isEditing && (
                    <label className="absolute inset-0 bg-black/40 flex items-center justify-center cursor-pointer opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <input
                        ...
                        className="hidden"
                        accept="image/*"
                        onChange={(e) => handlePassportChange(e, true)}
                      />
                    </label>
                  )}
                </div>
                ...
                {isEditing ? (
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-secondary font-medium text-sm">
                      {currentUser.businessName || "Independent Agent"}
                    </p>
            ...
            <div className="bg-gradient-to-r from-slate-800 to-slate-900 rounded-xl p-8 text-white flex flex-col md:flex-row items-center justify-between shadow-lg">
              <div className="mb-4 md:mb-0">
                ...
                <p className="text-gray-300 text-sm">
                  Upload details and get it listed on our marketplace.
                </p>
              </div>
              <button
        ...
        <div className="relative hidden md:block bg-slate-900">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-transparent to-transparent flex flex-col justify-end p-10 text-white">
            ...
            <p className="text-gray-300 mb-6">
              Connect with thousands of potential buyers and renters across
              Nigeria. Grow your real estate business with Neutech.
            </p>
            <div className="flex items-center space-x-2 text-sm text-secondary font-semibold">
              <CheckCircle size={16} /> <span>Verified Properties</span>
            </div>
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center min-h-[500px]">
            ...
            <>
              <div className="mb-6 text-center md:text-left">
                ...
                <p className="text-gray-500 text-xs">
                  Fill in the form to apply for an account.
                </p>
              </div>
          ...
          {authView === "VERIFY_OTP" && (
            <div className="text-center">
              ...
              {success && (
                <div className="bg-green-50 text-green-600 p-2 rounded mb-4 text-xs">
                  {success}
                </div>
              )}
              {error && (
