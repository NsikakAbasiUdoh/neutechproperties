...
import { Property, PropertyType, PropertyCategory, StateData, User, UserStatus, PropertyStatus, ClientRequest } from './types';

export const MAINTENANCE_MODE = false; // Change to true to enable maintenance screen
...
export const INITIAL_PROPERTIES: Property[] = [
  {
    ...
    images: ['https://picsum.photos/seed/house1/800/600', 'https://picsum.photos/seed/house1int/800/600', 'https://picsum.photos/seed/house1ext/800/600'],
    dateAdded: Date.now(),
  ...
  },
  {
    ...
    images: ['https://picsum.photos/seed/land1/800/600', 'https://picsum.photos/seed/land1map/800/600'],
  ...
  },
  {
    ...
    images: ['https://picsum.photos/seed/warehouse/800/600'],
...
export const INITIAL_REQUESTS: ClientRequest[] = [];
